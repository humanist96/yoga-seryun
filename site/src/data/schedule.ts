...
export const TIMES = ['12:00', '18:30', '20:00'] as const
...
export const SCHEDULE: readonly ScheduleEntry[] = [
  ...
  { day: '금', time: '18:30', name: '힐링하타', level: 2, teacher: '시소' },

  { day: '월', time: '20:00', name: '싱잉볼 이완명상', level: 2 },
  { day: '화', time: '20:00', name: '하타', level: 4, teacher: '나영' },
  { day: '수', time: '20:00', name: '아로마 호흡명상', level: 2, teacher: '시소' },
  { day: '목', time: '20:00', name: '아쉬탕가 LV1', level: 5, teacher: '나영' },
  { day: '금', time: '20:00', name: '근막테라피', level: 3, teacher: '시소' },
]
